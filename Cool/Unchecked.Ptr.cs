...
public static partial class Unchecked
{
    ...
    public unsafe struct Ptr<T>(T* pointer) where T : unmanaged
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ptr<T> operator +(Ptr<T> ptr, int offset) => new((T*)Unsafe.Add<T>(ptr.Pointer, offset));
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Ptr<T> operator -(Ptr<T> ptr, int offset) => new((T*)Unsafe.Subtract<T>(ptr.Pointer, offset));
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int operator -(Ptr<T> left, Ptr<T> right) => (int)Unsafe.ByteOffset(ref Unsafe.AsRef<T>(right.Pointer), ref Unsafe.AsRef<T>(left.Pointer)) / sizeof(T);
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
