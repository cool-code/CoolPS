...
{
    extension(CodePoint _value)
    {
        #region string representation
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public string ToUnicodeString() => $"U+{_value:X4}";
        #endregion

        #region range checks
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool IsBetween(CodePoint start, CodePoint end) => (_value - start) <= (end - start);
...
{
    #region bitmap fields initialized
    ...
    private static readonly ulong[] _wideBitmap = new ulong[(MaxCodePoint + 1) >> 6];
    private static readonly ulong[] _ambigBitmap = new ulong[(MaxCodePoint + 1) >> 6];
    private static readonly ulong[] _zeroBitmap = new ulong[(MaxCodePoint + 1) >> 6];
    private static readonly ulong[] _emojiBitmap = new ulong[(MaxCodePoint + 1) >> 6];

    static CodePointHelper()
    {
        // Fill the bitmaps based on the defined Unicode ranges for wide, ambiguous, zero-width, and emoji characters.
        FillBitmap(_wideRange, _wideBitmap);
        FillBitmap(_ambigRange, _ambigBitmap);
        FillBitmap(_zeroRange, _zeroBitmap);
        FillBitmap(_emojiRange, _emojiBitmap);
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static void SetBit(ulong[] bitmap, int codePoint) => bitmap[codePoint >> 6] |= 1UL << (codePoint & 63);

    private static void FillBitmap(string data, ulong[] bitmap)
    {
        ...
        foreach (var part in parts)
        {
            ...
            if (dashIndex > 0)
            {
                ...
                for (int i = start; i <= end; i++) SetBit(bitmap, i);
            }
            else
            {
                int cp = int.Parse(part, NumberStyles.HexNumber);
                if (cp <= MaxCodePoint) SetBit(bitmap, cp);
            }
        }
    }
    #endregion
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool IsWideWidth(this CodePoint codePoint) => ((codePoint <= MaxCodePoint) && ((_wideBitmap[codePoint >> 6] & (1UL << (int)(codePoint & 63))) != 0)) || (((codePoint - 0x20000u) & ~0x10000u) <= 0xFFFDu);
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool IsAmbiguousWidth(this CodePoint codePoint) => ((codePoint <= MaxCodePoint) && ((_ambigBitmap[codePoint >> 6] & (1UL << (int)(codePoint & 63))) != 0)) || (((codePoint - 0xF0000u) & ~0x10000u) <= 0xFFFDu);
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool IsZeroWidth(this CodePoint codePoint) => ((codePoint <= MaxCodePoint) && ((_zeroBitmap[codePoint >> 6] & (1UL << (int)(codePoint & 63))) != 0)) || (codePoint - 0xE0000u <= 0xE007Fu - 0xE0000u) || (codePoint - 0xE0100u <= 0xE01EFu - 0xE0100u);

    /// <summary>
    /// Check if the code point is in the bitmap for emoji characters, which allows for O(1) checks for code points up to 0x1FFFF.
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool IsEmoji(this CodePoint codePoint) => (codePoint <= MaxCodePoint) && ((_emojiBitmap[codePoint >> 6] & (1UL << (int)(codePoint & 63))) != 0);
}
*/
...
public static class CodePointHelper
{
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool IsWideWidth(this CodePoint codePoint) => wideBitmap.GetBit((int)codePoint) || (((codePoint - 0x20000u) & ~0x10000u) <= 0xFFFDu);
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool IsAmbiguousWidth(this CodePoint codePoint) => ambigBitmap.GetBit((int)codePoint) || (((codePoint - 0xF0000u) & ~0x10000u) <= 0xFFFDu);
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool IsZeroWidth(this CodePoint codePoint) => zeroBitmap.GetBit((int)codePoint) || (codePoint - 0xE0000u <= 0xE007Fu - 0xE0000u) || (codePoint - 0xE0100u <= 0xE01EFu - 0xE0100u);

    /// <summary>
    /// Check if the code point is in the bitmap for emoji characters, which allows for O(1) checks for code points up to 0x1FFFF.
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool IsEmoji(this CodePoint codePoint) => emojiBitmap.GetBit((int)codePoint);
}