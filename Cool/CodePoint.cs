...
public readonly struct CodePoint(uint value) : IEquatable<CodePoint>, IComparable<CodePoint>
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly int CompareTo(CodePoint other) => _value.CompareTo(other._value);
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly bool Equals(CodePoint other) => _value == other._value;
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    #region range checks
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly bool IsBetween(CodePoint start, CodePoint end) => (_value - start._value) <= (end._value - start._value);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly bool IsBetween(int start, int end) => (_value - (uint)start) <= ((uint)end - (uint)start);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly bool IsBetween(char start, char end) => (_value - start) <= (end - start);
    #endregion
