...
public static class CodePointExtensions
{
    ...
    unsafe static CodePointExtensions()
    {
    ...
    extension(CodePoint _value)
    {
        ...
        /// 
        /// </summary>
        public unsafe bool IsWideWidth
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => ((_value <= MaxCodePoint) && ((_widePtr[_value >> 6] & (1UL << (int)(_value & 63))) != 0)) || (((_value - 0x20000u) & ~0x10000u) <= 0xFFFDu);
        }
        ...
        /// 
        /// </summary>
        public unsafe bool IsAmbiguousWidth
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => ((_value <= MaxCodePoint) && ((_ambigPtr[_value >> 6] & (1UL << (int)(_value & 63))) != 0)) || (((_value - 0xF0000u) & ~0x10000u) <= 0xFFFDu);
        }
        ...
        /// </summary>
        public unsafe bool IsZeroWidth
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => ((_value <= MaxCodePoint) && ((_zeroPtr[_value >> 6] & (1UL << (int)(_value & 63))) != 0)) || (_value - 0xE0000u <= 0xE007Fu - 0xE0000u) || (_value - 0xE0100u <= 0xE01EFu - 0xE0100u);
        }

        /// <summary>
        /// Check if the code point is in the bitmap for emoji characters, which allows for O(1) checks for code points up to 0x1FFFF.
        /// </summary>
        public unsafe bool IsEmoji
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => (_value <= MaxCodePoint) && ((_emojiPtr[_value >> 6] & (1UL << (int)(_value & 63))) != 0);
        }
