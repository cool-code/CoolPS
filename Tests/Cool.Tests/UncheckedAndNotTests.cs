...
{
    public class UncheckedAndNotTests
    {
        [Fact]
        public void AndNot_Bytes_PerformsBitwiseAndNotAll()
        {
            ...
            Unchecked.AndNot(ref left.GetReference(), ref right.GetReference(), (nuint)left.Length);
        ...
        [InlineData(47)]
        [InlineData(63)]
        public void AndNot_Bytes_SlightlyLargerThanSingleVector_PerformsBitwiseAndNot(int len)
        {
        ...
        [InlineData(31)]
        [InlineData(65)]
        public void AndNot_Bytes_SoftwareFallbackEdgeCases_PerformsBitwiseAndNot(int len)
        {
            byte[] left = new byte[len];
            byte[] right = new byte[len];
        ...
        [Fact]
        public void AndNot_UInt32_PerformsBitwiseAndNotAll()
        {
        ...
        [Fact]
        public void AndNot_Partial_InAndPrefixOnly()
        {
            ...
            Unchecked.AndNot(ref left.GetReference(), ref right.GetReference(), (nuint)2);
        ...
        [Fact]
        public void AndNot_ZeroElements_NoOp()
        {
            int[] left = new int[] { 5, 6, 7 };
            int[] right = new int[] { 1, 2, 3 };
            var original = (int[])left.Clone();

            Unchecked.AndNot(ref left.GetReference(), ref right.GetReference(), (nuint)0);
        ...
        [Fact]
        public void AndNot_CustomUnmanagedStruct_PerformsFieldwiseAndNot()
        {
            int len = 5;
