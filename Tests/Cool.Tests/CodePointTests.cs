...
namespace Cool.Tests
{
    public class CodePointTests
    {
        ...
        public void AllCodePoints_BasicProperties_Exhaustive()
        {
            ...
            var wideBitmap = new BitSet<Fixed16KB>(0x1FFFFu, wideRange);
            var ambigBitmap = new BitSet<Fixed16KB>(0x1FFFFu, ambigRange);
            var zeroBitmap = new BitSet<Fixed16KB>(0x1FFFFu, zeroRange);
            var emojiBitmap = new BitSet<Fixed16KB>(0x1FFFFu, emojiRange);
            ...
            for (uint v = 0; v <= MaxUnicode; v++)
            {
                ...
                bool expectedWide = wideBitmap.Contains(v) || ((v - 0x20000u) & ~0x10000u) <= 0xFFFDu;
                ...
                bool expectedAmbig = ambigBitmap.Contains(v) || ((v - 0xF0000u) & ~0x10000u) <= 0xFFFDu;
                ...
                bool expectedZero = zeroBitmap.Contains(v) || (v - 0xE0000u <= 0xE007Fu - 0xE0000u) || (v - 0xE0100u <= 0xE01EFu - 0xE0100u);
                ...
                bool expectedEmoji = emojiBitmap.Contains(v);
