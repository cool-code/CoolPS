...
{
    public class UncheckedAndTests
    {
        [Fact]
        public void And_Bytes_PerformsBitwiseAndAll()
        {
            ...
            Unchecked.And(ref left.GetReference(), ref right.GetReference(), (nuint)left.Length);
        ...
        [InlineData(47)]
        [InlineData(63)]
        public void And_Bytes_SlightlyLargerThanSingleVector_PerformsBitwiseAnd(int len)
        {
        ...
        [InlineData(31)]
        [InlineData(65)]
        public void And_Bytes_SoftwareFallbackEdgeCases_PerformsBitwiseAnd(int len)
        {
            byte[] left = new byte[len];
            byte[] right = new byte[len];
        ...
        [Fact]
        public void And_UInt32_PerformsBitwiseAndAll()
        {
        ...
        [Fact]
        public void And_Partial_InAndPrefixOnly()
        {
            ...
            Unchecked.And(ref left.GetReference(), ref right.GetReference(), (nuint)2);
        ...
        [Fact]
        public void And_ZeroElements_NoOp()
        {
            int[] left = new int[] { 5, 6, 7 };
            int[] right = new int[] { 1, 2, 3 };
            var original = (int[])left.Clone();

            Unchecked.And(ref left.GetReference(), ref right.GetReference(), (nuint)0);
        ...
        [Fact]
        public void And_CustomUnmanagedStruct_PerformsFieldwiseAnd()
        {
            int len = 5;
