...
namespace Cool.Benchmarks
{
    ...
    public class UncheckedOrByteBenchmarks
    {
        [Params(8, 200, 8192)]
        ...
        public void Or_Bytes()
        {
            ...
            Unchecked.Or(ref l, ref r, (nuint)ByteCount);
        }

        [Benchmark(Baseline = true)]
        public void Manual_Or_Bytes()
        {
    ...
    [MemoryDiagnoser]
    [DisassemblyDiagnoser(maxDepth: 5, printSource: true)]
    public class UncheckedOrUlongBenchmarks
    {
        [Params(1, 25, 1024)]
        ...
        [Benchmark]
        public void Or_Ulongs()
        {
            ref ulong l = ref leftBuffer!.GetReference();
            ref ulong r = ref rightBuffer!.GetReference();
            Unchecked.Or(ref l, ref r, (nuint)ElementCount);
        }

        [Benchmark(Baseline = true)]
        public void Manual_Or_Ulongs()
        {
