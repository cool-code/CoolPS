...
namespace Cool.Benchmarks
{
    ...
    public class BitSetCreateBenchmarks
    {
        ...
        [Benchmark]
        public nuint Create_Wide() => new BitSet<Fixed16KB>(MaxCodePoint, WideRange).BitHighLimit;

        [Benchmark]
        public nuint Create_Sparse() => new BitSet<Fixed16KB>(MaxCodePoint, SparseRange).BitHighLimit;

        [Benchmark]
        public nuint Create_Dense() => new BitSet<Fixed16KB>(MaxCodePoint, DenseRange).BitHighLimit;
    }
}
